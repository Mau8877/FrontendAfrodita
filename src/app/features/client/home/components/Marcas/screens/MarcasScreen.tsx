...
const MARCAS = [
  { id: 1, name: 'FreshLady', img: logoFreshLady, slogan: 'Elegancia Natural' },
  { id: 2, name: 'UrbanLayer', img: logoUrbanLayer, slogan: 'Estilo Urbano' },
  { id: 3, name: 'FreshGo', img: logoFreshGo, slogan: 'Comodidad Diaria' },
  { id: 4, name: 'Magister', img: logoMagister, slogan: 'Mirada Profesional' },
]
...
export function MarcasScreen() {
  return (
    <section className="py-8 md:py-24 w-full flex flex-col items-center px-1 md:px-12 bg-white">
      ...
      {/* ENCABEZADO: Ahora visible en móvil */}
      <div className="text-center mb-8 md:mb-16 space-y-2 md:space-y-1">
        ...
        {/* Eliminamos el 'hidden md:block' para que aparezca en móvil */}
