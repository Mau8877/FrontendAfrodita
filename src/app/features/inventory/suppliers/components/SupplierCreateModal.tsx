...
import { Type, Phone, Truck } from "lucide-react"
import { toast } from "sonner"
import { supplierSchema } from "../schemas"
import { useCreateSupplierMutation } from "../store/suppliersApi"
...
export function SupplierCreateModal({ isOpen, onClose }: SupplierCreateModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[500px] w-[95vw] bg-white rounded-[2.5rem] border-none shadow-2xl p-0 overflow-hidden flex flex-col">
        ...
        {/* HEADER VERDE - CONSISTENTE CON LA GESTIÓN DE CATÁLOGO */}
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <DialogDescription className="text-[9px] font-bold text-emerald-600/60 uppercase tracking-widest mt-0.5">
                Registra nuevas fuentes de abastecimiento para el inventario.
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col flex-grow overflow-hidden">
            ...
            <DialogFooter className="p-6 bg-slate-50 border-t border-slate-100 gap-3 flex-shrink-0">
              ...
              >
                {isLoading ? "Registrando..." : "Guardar Proveedor"}
              </Button>
            </DialogFooter>
